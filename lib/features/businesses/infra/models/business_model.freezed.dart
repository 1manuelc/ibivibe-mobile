...
mixin _$BusinessModel {
 ...
 String get id; String get slug; String? get cnpj; String get name; String? get description;@JsonKey(unknownEnumValue: ReachLevel.local, name: 'max_reach_level') ReachLevel get maxReachLevel;@JsonKey(name: 'cover_img_url') String? get coverImgUrl; List<String> get categories;@JsonKey(name: 'created_at') DateTime get createdAt;@JsonKey(name: 'updated_at') DateTime get updatedAt;
...
@override
String toString() {
  return 'BusinessModel(id: $id, slug: $slug, cnpj: $cnpj, name: $name, description: $description, maxReachLevel: $maxReachLevel, coverImgUrl: $coverImgUrl, categories: $categories, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
class _BusinessModel extends BusinessModel {
  const _BusinessModel({this.id = '', this.slug = '', this.cnpj, this.name = '', this.description, @JsonKey(unknownEnumValue: ReachLevel.local, name: 'max_reach_level') required this.maxReachLevel, @JsonKey(name: 'cover_img_url') this.coverImgUrl, final  List<String> categories = const [], @JsonKey(name: 'created_at') required this.createdAt, @JsonKey(name: 'updated_at') required this.updatedAt}): _categories = categories,super._();
